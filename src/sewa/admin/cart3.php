...
<div class="container">
    <div class="panel">
        ...
        <div class="panel-body">
            ...
            <a href="keranjang3.php" class="btn btn-sm btn-info pull-right">Tambah Barang</a>
            ...
            <table class="table table-bordered table-striped">
                ...
                ?>
                    <tr>
                        ...
                        <td>Rp.<?php echo number_format($d['product_omp']); ?></td>
            ...
            <a href="checkout3.php" class="btn btn-sm btn-info pull-right">Checkout</a>
        </div>
    </div>
</div>
